...
clinic_plac6$tempNA <- NA_real_
clinic_plac6[is.na(clinic_plac6$FUTIME)==TRUE,]$tempNA <- tempNA2
clinic_plac6$tempNA.count <- NA_real_
...
clinic_plac8 <- fill(clinic_plac7 %>% group_by(ID_CPPT), -ID_CPPT, .direction="down") %>%  # impute by carrying forward
